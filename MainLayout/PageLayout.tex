...
\fancyhead[LE]{%
  \makebox[0pt][r]{
    \colorbox{blue}{\makebox[\textwidth][r]{\bfseries\textcolor{white}{\thepage}\enskip}}\hspace*{1em}}{\itshape\rightmark}\hspace*{1em}\headrulefill%
}

\fancyhead[RO]{%
  \mbox{}\headrulefill \hspace*{1em}{\itshape\leftmark}%
  \makebox[0pt][l]{%
    \hspace*{1em}\colorbox{blue}{\makebox[\textwidth][l]{\enskip\bfseries\textcolor{white}{\thepage}}}}%
}
...
\fancypagestyle{plain}{
    \fancyhead[LE]{%
    \makebox[0pt][r]{
    \colorbox{blue}{\makebox[\textwidth][r]{\bfseries\textcolor{white}{\thepage}\enskip}}\hspace*{1em}}%
...
\DeclareCaptionFormat*{custom}{
    ...
    \centering
    \hspace{-25pt} 
    \begin{tabular}{p{45pt}@{\hspace{0.0em}} !{\color{blue}\vrule width 2pt} p{0.9\linewidth-30pt}}
    \hspace{-0.05\linewidth} {\colorbox{blue}{\parbox[t][10pt][l]{38pt}{\bfseries\textcolor{white}{#1}}}}
